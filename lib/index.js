...
Note.prototype.write = function write(cb, err, x) {
    this.cb = cb;
    this.err = err;
    this.x = x;
};

Note.prototype.clear = function clear() {
    this.cb = null;
    this.err = null;
    this.x = null;
};
...
Stream.prototype._send = function (token) {
    ...
    if (this._request) {
        ...
        if (cb.__InternalPullCb__ != null) {
            ...
            if (this._is_rec_send) {
                note = this._is_rec_send;
                note.write(cb, err, x);
            }
            else {
                note = this._note;
